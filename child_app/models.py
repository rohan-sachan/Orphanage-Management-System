...
class Child(models.Model):
    childid = models.CharField(db_column='ChildID', primary_key=True, max_length=10)  # Field name made lowercase.
    ...
    cphoto = models.CharField(db_column='CPhoto', max_length=200, blank=True, null=True)  # Field name made lowercase.
    cano = models.CharField(db_column='CAno', max_length=12, blank=True, null=True)  # Field name made lowercase.
    cpno = models.CharField(db_column='CPno', max_length=10, blank=True, null=True)  # Field name made lowercase.
    gname = models.CharField(db_column='GName', max_length=40, blank=True, null=True)  # Field name made lowercase.
    gano = models.CharField(db_column='GAno', max_length=12, blank=True, null=True)  # Field name made lowercase.
    gpno = models.CharField(db_column='GPno', max_length=10, blank=True, null=True)  # Field name made lowercase.
